...
fun CartContent(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(state.orderEigerProduct, key = { it.eigerProduct.id }) { item ->
                CartItem(
                    eigerProductId = item.eigerProduct.id,
                    image = item.eigerProduct.image,
                    title = item.eigerProduct.title,
                    totalPrice = item.eigerProduct.requiredPrice * item.count,
                    count = item.count,
